...
aircraft.light.new("controls/lighting/beacon-state", [0.5, 0.5, 0.5, 0.5, 0.5, 1.5], beacon_switch);
...
#props.globals.getNode("controls/gear/brake-parking", 1).setBoolValue(0);
